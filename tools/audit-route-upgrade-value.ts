...
import { UPGRADE_ARCHETYPES } from '../src/data/upgrades';
import { estimateUpgradeValue, getUpgradeRarityMultiplier } from '../src/data/balance';
...
const VALUE_REFERENCE = {
  ...
  dashPulseDamage: 1 / 3,     // dashPulseDamage +3 ≈ 1点
