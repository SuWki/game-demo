...
const ROUTE_DESCRIPTION_OVERRIDES: Record<string, string> = {
  ...
  'crit-heat-rake': '对带破绽目标的追击能力增强。',
  'crit-heat': '破绽爆发的单体伤害更高。',
  'crit-cascade': '破绽触发后更容易击杀下一个目标。',
  'crit-superheat': '连续重击触发更高一波爆发。',
  'crit-finish': '破绽爆发完成最终输出，对低血量目标伤害更高。',

  // 穿透流 - 裂纹机制
  'pierce-core': '子弹穿过敌人继续飞行，命中后排目标。',
