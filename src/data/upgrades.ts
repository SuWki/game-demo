...
export const UPGRADE_ARCHETYPES: UpgradeArchetype[] = [
  ...
  },
  {
    ...
    name: '并轨穿脊',
    description: '穿透命中后，后排敌人更容易受到连锁伤害。',
    category: 'route',
    routeId: 'pierce',
    tags: ['bridge'],
    selection: {
  ...
  },
  {
    ...
    name: '拆账铺面',
    description: '强化穿透的中后段效果，整条穿透路线伤害提升。',
    category: 'route',
    routeId: 'pierce',
    tags: ['bridge'],
    selection: {
  ...
  },
  {
    id: 'dash-slipstream',
    name: '穿梭余程',
    description: '穿梭充能速度提升12%，反击伤害提升12%，接近范围+10。',
    category: 'route',
    routeId: 'dash',
    tags: ['bridge'],
    selection: {
  ...
  },
  {
    id: 'dash-sidechannel',
    name: '错位取样',
    description: '反击伤害提升18%，接近范围+8，恢复6点生命。',
    category: 'route',
    routeId: 'dash',
    tags: ['bridge', 'redirect'],
    selection: {
  ...
  },
  {
    ...
    name: '偏帧切入',
    description: '穿梭充能速度提升，接近敌人后反击伤害提升。',
    category: 'route',
    routeId: 'dash',
    tags: ['bridge', 'redirect'],
    selection: {
  ...
  },
  {
    id: 'dash-return-hold',
    name: '回线留窗',
    description: '穿梭充能速度提升8%，反击伤害提升10%。',
    category: 'route',
    routeId: 'dash',
    tags: ['bridge'],
    selection: {
  ...
  },
  {
    ...
    name: '回线追拍',
    description: '穿梭充能速度提升10%，反击伤害提升12%。',
    category: 'route',
    routeId: 'dash',
    tags: ['bridge', 'payoff'],
    selection: {
  ...
  },
  {
    id: 'dash-reentry',
    name: '回环汲能',
    description: '穿梭充能速度提升10%，反击伤害提升15%。',
    category: 'route',
    routeId: 'dash',
    tags: ['bridge', 'payoff'],
    selection: {
  ...
  },
  {
    id: 'dash-anchor',
    name: '穿梭定标',
    description: '穿梭接近、反击、消灭的整体稳定性提升。',
    category: 'route',
    routeId: 'dash',
    tags: ['finisher'],
    selection: {
...
const ROUTE_DESCRIPTION_OVERRIDES: Record<string, string> = {
  ...
  'crit-crownfire': '破绽爆发后下一次攻击更容易衔接连击。',
  'crit-ember-rail': '多层破绽同时爆发时伤害显著提升。',
  'crit-redline': '短时间内压制能力增强，暴击伤害提升。',
  'crit-heat-rake': '对带有破绽标记的目标追击能力增强。',
  'crit-heat': '破绽爆发的单体伤害提升。',
  'crit-cascade': '破绽触发后更容易继续击杀下一个目标。',
  'crit-superheat': '连续重击会触发一波更高的爆发伤害。',
  ...
  'pierce-echo': '穿透命中后回响效率提升，造成额外伤害。',
  'pierce-ripple': '裂纹扩散速度提升，更容易传到后方敌人。',
  'pierce-ledger-line': '穿透敌人后，后排敌人持续受到伤害。',
  'pierce-bloom': '裂纹范围扩大，更容易同时命中多个敌人。',
  'pierce-chain': '穿透距离增加，后排敌人更容易连续受到伤害。',
  ...
  'dash-cutback': '脉冲层数满后反击伤害显著提升。',
  'dash-slipstream': '穿梭速度提升，反击更加稳定。',
  'dash-sidechannel': '接近敌人更加顺畅，反击伤害增加。',
  ...
  'dash-rebound-window': '接近敌人后反击触发概率提升。',
  'dash-rethread': '接近敌人的间隔缩短，反击伤害增加。',
  'dash-reentry': '反击后更容易补上额外伤害。',
  'dash-anchor': '接近、反击、消灭的整体稳定性提升。',
  'dash-zero-window': '脉冲层数满后命中标记敌人伤害大幅提升。',
};

function getUpgradeDescription(archetype: UpgradeArchetype, effects: ContentEffect[]): string {
  if (archetype.category === 'route') {
    return ROUTE_DESCRIPTION_OVERRIDES[archetype.id] ?? '选择后，该流派的战斗能力将获得提升。';
  }
