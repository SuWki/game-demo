...
const ANOMALY_ROUTE_POOLS: Record<AnomalyRoutePoolId, AnomalyRoutePool> = {
  ...
  relaySplice: {
    crit: {
      ...
      label: '改道暴击侧路',
      description: '恢复 8 点耐久，补一段暴击火力并改向暴击。',
      routeId: 'crit',
      effects: [
        {
          type: 'stats',
    ...
    pierce: {
      ...
      label: '改道穿透旁路',
      description: '恢复 8 点耐久，接入穿透清线并改向穿透。',
      routeId: 'pierce',
      effects: [
        {
          type: 'stats',
    ...
    dash: {
      ...
      label: '改道穿梭侧路',
      description: '恢复 8 点耐久，接入换位节奏并改向穿梭。',
      routeId: 'dash',
      effects: [
        {
          type: 'stats',
  ...
  routeHandoff: {
    crit: {
      ...
      gameplayLabel: '起手',
      gainLabel: '先把暴击打顺',
      costLabel: '还没到连着重击的时候',
      anomalyRole: 'direction',
      description: '补一段暴击火力，顺手把打法带到暴击上。',
      routeId: 'crit',
      effects: [
        {
          type: 'stats',
    ...
    pierce: {
      ...
      costLabel: '还不能立刻带到后排',
      anomalyRole: 'direction',
      description: '补一段穿透火力，顺手把打法带到穿透上。',
      routeId: 'pierce',
      effects: [
        {
          type: 'stats',
    ...
    dash: {
      ...
      costLabel: '还不能马上贴身收人',
      anomalyRole: 'direction',
      description: '补一段穿梭节奏，顺手把打法带到贴身快打上。',
      routeId: 'dash',
      effects: [
        {
          type: 'stats',
  ...
  critRerouteWindow: {
    ...
    pierce: {
      ...
      label: '改道穿透清线',
      description: '修复 8 点损伤，顺手把打法带到穿透上。',
      routeId: 'pierce',
      effects: [
        {
          type: 'stats',
    ...
    dash: {
      ...
      label: '改道穿梭反打',
      description: '修复 8 点损伤，顺手把打法带到穿梭上。',
      routeId: 'dash',
      effects: [
        {
          type: 'stats',
  ...
  pierceRerouteWindow: {
    crit: {
      ...
      label: '改道暴击收束',
      description: '修复 8 点损伤，顺手把打法带到暴击上。',
      routeId: 'crit',
      effects: [
        {
          type: 'stats',
  ...
  crossBranchSignal: {
    ...
    dash: {
      ...
      label: '改打穿梭',
      description: '补一段穿梭节奏，顺手把打法带到穿梭上。',
      routeId: 'dash',
      effects: [
        {
          type: 'stats',
